<section class="team-one">
    <div class="team-one__shape-1 float-bob-y">
        <img src="{{Module::asset('client:images/shapes/team-one-shape-1.png')}}" alt="">
    </div>
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="team-one__single">
                    <div class="team-one__img">
                        <div class="team-one__img-box">
                            <img src="{{Module::asset('client:images/team/team-1-1.jpg')}}" alt="">
                        </div>
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                <div class="team-one__single">
                    <div class="team-one__img">
                        <div class="team-one__img-box">
                            <img src="{{Module::asset('client:images/team/team-1-2.jpg')}}" alt="">
                        </div>
                        <ul class="list-unstyled team-one__social">
                            <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                            <li><a href="#"><i class="fab fa-twitter"></i></a></li>
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                <div class="team-one__single">
                    <div class="team-one__img">
                        <div class="team-one__img-box">
                            <img src="{{Module::asset('client:images/team/team-1-3.jpg')}}" alt="">
                        </div>
                        <ul class="list-unstyled team-one__social">
                            <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                            <li><a href="#"><i class="fab fa-twitter"></i></a></li>
