    ...
    <div class="container">
        <div class="tracking__inner">
            <div class="tracking-shape-1 float-bob-y">
                <img src="{{Module::asset('client:images/shapes/tracking-shape-1.png')}}" alt="">
            </div>
            <div class="tracking-shape-2 float-bob-x">
                <img src="{{Module::asset('client:images/shapes/tracking-shape-2.png')}}" alt="">
            </div>
            <div class="tracking-shape-3 float-bob-x">
                <img src="{{Module::asset('client:images/shapes/tracking-shape-3.png')}}" alt="">
            </div>
            <div class="tracking-shape-4 float-bob-y">
                <img src="{{Module::asset('client:images/shapes/tracking-shape-4.png')}}" alt="">
            </div>
