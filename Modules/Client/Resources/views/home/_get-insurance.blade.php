<section class="get-insurance">
    <div class="get-insurance-bg"
         style="background-image: url({{Module::asset('client:images/backgrounds/get-insurance-bg.png')}});"></div>
    <div class="container">
        <div class="row">
            <div class="col-xl-6">
                <div class="get-insurance__left">
                    <div class="get-insurance__img wow slideInLeft" data-wow-delay="100ms"
                        ...
                        <img src="{{Module::asset('client:images/resources/get-insurance-img-1.png')}}" alt="">
                    </div>
                    ...
                    <div class="get-insurance__shape-1 float-bob-x">
                        <img src="{{Module::asset('client:images/shapes/get-insurance-shape-1.png')}}" alt="">
                    </div>
                </div>
            </div>
            <div class="col-xl-6">
