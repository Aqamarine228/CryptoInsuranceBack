...
<div class="card">
    ...
    <div class="card-body">
        <form id="insurance-option-update-image" action="{{ route('admin.insurance-option.update-picture', $insuranceOption->id) }}"
              method="post"
    ...
    <div class="card-footer">
        <button form="insurance-option-update-image" class="btn btn-primary">Upload</button>
    </div>
    @if ($insuranceOption->picture)
        <div class="card-body">
            <img class="img-fluid" src="{{ Storage::url($insuranceOption->getPicturePath($insuranceOption->picture)) }}" alt="picture">
        </div>
    @endif
</div>
...
@push('scripts')
    ...
    <script>
        let App = {
            fileId: '#picture',
            modalId: '#insurance-option-crop-image-modal',
